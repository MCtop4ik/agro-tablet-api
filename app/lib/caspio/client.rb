    ...
    def create_production_transactions_parser(data)
      {
        ...
        'Total_Time_Hours' => (data['Total_Hours'].present? && !data['Total_Hours'].empty?) ? data['Total_Hours'] : nil,
        'Tons_Baled' => (data['Tons_Baled'].present? && !data['Tons_Baled'].empty?) ? data['Tons_Baled'] : nil,
        'Bales_Baled' => (data['Bales_Baled'].present? && !data['Bales_Baled'].empty?) ? data['Bales_Baled'] : nil,
        'Average_Moisture_Percent' => (data['Moisture'].present? && !data['Moisture'].empty?) ? data['Moisture'] : nil,
        'Active_YN' => true,
      }
    end
